...
set_number = input("What set number would you like to process")



path = os.path.join(curDir, "images", "Set"+set_number)
...
for img_name in file_list:
    ...
    if img2process is not None:
        ...
        print(f"{img_name} has been processed in set {set_number}")

cv2.destroyAllWindows()

print(f"This code has been executed for Set {set_number}")

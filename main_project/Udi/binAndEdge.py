...
if __name__ == "__main__":
    ogImage = Image.open("/Users/udiram/Documents/GitHub/FitnessDetection/main/pics/1.png")
    ...
    testImage.save('/Users/udiram/Documents/GitHub/FitnessDetection/main/pics/bandw.png')

    img = cv2.imread('/Users/udiram/Documents/GitHub/FitnessDetection/main/pics/bandw.png')
    ...
    for i in range(1, n_labels):
        if stats[
            ...
            if 10000 < w * h:  # > 30: gotta make the 100 value variable ask seb
                result.save("/Users/udiram/Documents/GitHub/FitnessDetection/main/pics/crop" + str(i) + ".jpg")
                # columnList.append((x, x + w))
                # LadderReduce.ladderReduce(result, x, w)
        # print(columnList)
        cv2.imwrite("/Users/udiram/Documents/GitHub/FitnessDetection/main/pics/out.png", img)

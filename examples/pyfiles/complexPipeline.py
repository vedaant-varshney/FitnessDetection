...
if __name__ == "__main__":
    ...
    while (cap.isOpened()):
        ...
        if i % 50 == 0:  # this is the line I added to make it only save one frame every 20
            ...
            testImage.save(
                '/Users/udiram/Documents/GitHub/FitnessDetection/examples/pics/binandextractblackandwhite.png')
            ...
            for i in range(1, n_labels):
                if stats[
                    ...
                    if 10000 < w * h:  # > 30: gotta make the 100 value variable ask seb
                        result.save(
                            "/Users/udiram/Documents/GitHub/FitnessDetection/examples/pics/binandextractcrop.jpg")
                        # columnList.append((x, x + w))
                        # LadderReduce.ladderReduce(result, x, w)
                # print(columnList)
            cv2.imwrite("/Users/udiram/Documents/GitHub/FitnessDetection/examples/pics/binandextractout " + str(i) + ".png", img)
        i += 1
